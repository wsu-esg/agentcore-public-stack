#!/bin/bash
# SageMaker Fine-Tuning CDK build script - Compile TypeScript CDK code
# This script compiles the CDK infrastructure code for the SageMaker Fine-Tuning stack
